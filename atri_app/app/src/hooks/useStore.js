...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image1": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c309aa0721dacedf0a_logo-restaurante-x-template.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image33": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dc50743f41639377b2fd8_ice-cream-restaurante-x-template-p-500%20(1).jpeg"
      },
      "callbacks": {
        "onClick": [
          {
